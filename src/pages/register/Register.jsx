            ...
            {success ? (
                ...
                <section className="registerSection">
                    ...
                    <form className="registerForm" onSubmit={handleClick}>
                        <label className="register-text" htmlFor="username">
                            Username:
                        ...
                        <p id="uemailnote" className={emailFocus && email && !validEmail ? "instructions" : "offscreen"}>
                            <FontAwesomeIcon icon={faInfoCircle} />
                            Must include an '@'in the email address.<br />
                            A part must follow '@'.
                        </p>
                        ...
                        <label className="register-text"  htmlFor="confirm_pwd">
                            Confirm Password:
                        ...
                        <button className="register-btn" disabled={!validName || !validPwd || !validMatch ? true : false}>Sign Up</button>
                    </form>
                    <p>
